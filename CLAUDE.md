...
**Agent policy:** [AGENTS.md](AGENTS.md) is the provider-neutral entrypoint. [docs/COORDINATION.md](docs/COORDINATION.md) owns repository-wide claims, worktree fences, review handoffs, and releases. Every repository edit starts with a live GitHub-Issue claim; read-only planning and review remain parallel.
