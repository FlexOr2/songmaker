...
ACESTEP_CONFIG: Final[AceStepConfig] = AceStepConfig(
    ...
    lyrics=(
        ...
        "Map DE Aztec, let's go!\n"
        "\n"
        "[verse]\n"
        "Runde eins, CT Spawn, AWP in der Hand,\n"
        ...
        "Nächste Runde, weiter geballert!\n"
        "\n"
        "[chorus]\n"
        "Fire in the Hole! Power Terminators kommen rein,\n"
        "Militia, Aztec, Dust, alles mein!\n"
        "Fire in the Hole! AWP, AK, Deagle am Start,\n"
        "Frag um Frag, Power Terminators, hart!\n"
        "\n"
        "[verse]\n"
        "Vier Uhr morgens, Bildschirm brennt, Augen rot,\n"
        "Pizza aufm Boden, Schlaf ist tot, Red Bull tot,\n"
        "Du Spaßt, kauf Kevlar! Halts Maul, ich spar auf AWP!\n"
        "Bomb planted B Site, Ticker tickt, wir clutchen das!\n"
        "\n"
        "Plötzlich Wallhack, Scheiß Cheater, Aimbot durch die Wand,\n"
        ...
        "Flexx0r wartet, Scope, Zoom, Kopf, erledigt!\n"
        "\n"
        "[chorus]\n"
        "Fire in the Hole! Power Terminators kommen rein,\n"
        "Militia, Aztec, Dust, alles mein!\n"
        ...
        "Hör ich Fire in the Hole\n"
        "\n"
        "[chorus]\n"
        "FIRE IN THE HOLE! Power Terminators!\n"
        "Noob Saibot! Kill O Zap! Tobbisch! Flexx0r!\n"
        "HEADSHOT! HEADSHOT! GAME OVER!\n"
        "\n"
        "[outro]\n"
        "Server disconnected, GG WP\n"
    ),
    bpm=90,
    duration=210,
    key="Am",
