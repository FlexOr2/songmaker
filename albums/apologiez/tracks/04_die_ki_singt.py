"""Track 04 — Die KI singt fuer dich.
...
ACESTEP_CONFIG: Final[AceStepConfig] = AceStepConfig(
    ...
    lyrics=(
        ...
        "Ploetzlich klingt es fast nach Musik, ich dreh mich im Kreis, ich bin Hound,\n"
        "Zehn Stunden rendern fuer drei Minuten Song,\n"
        "Meine GPU gluegt, aber Tobi, es hat sich gelohnt!\n"
        "\n"
        "[chorus]\n"
        "Die KI singt fuer dich,\n"
        "Weil ich es selber nicht kann,\n"
        ...
        "Du hoerst sofort wenn irgendwas nicht stimmen kann,\n"
        "Und ja, das hier ist kuenstlich, fake, aus Nullen und aus Einsen,\n"
        "Aber die Gefuehle dahinter, Bruder, die sind meins!\n"
        "\n"
        "[chorus]\n"
        "Die KI singt fuer dich,\n"
        "Weil ich es selber nicht kann,\n"
        "Die KI singt fuer dich,\n"
        "Und sie wird besser, Song fuer Song, das ist der Plan!\n"
        "Ich hab keine Stimme, aber ich hab nen Freund,\n"
        "Der das hier hoert und vielleicht, vielleicht, ein bisschen weint,\n"
        "Die KI singt fuer dich,\n"
        "Tobi, das hier ist fuer dich!\n"
        "\n"
        "[outro]\n"
        "Die KI singt fuer dich...\n"
...
def main() -> None:
    ...
    print("=" * 60)
    print(f"  Die KI singt fuer dich — v{version}")
