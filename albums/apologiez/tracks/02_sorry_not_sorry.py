...
ACESTEP_CONFIG: Final[AceStepConfig] = AceStepConfig(
    ...
    lyrics=(
        ...
        "Du hast auf Play gedrueckt in Berlin,\n"
        "Und ich sass in Erlangen und hab gewartet auf ein Zeichen\n"
        "\n"
